        ...
        var v = logged({
          ...
          view: logged({
            ...
            _hideToolbarPromptControls: function () {
              ...
              if (!inMobile) {
                domClass.add('toolbar-parameter-separator', 'hidden');
              }
            ...
            _initLayout: function () {
              if (this._layoutInited) {
                return;
              } // reset on every navigation (see #init)
              ...
              if (!showParamUI) {
                ...
                showOrHide = (!inMobile && _isTopReportViewer) ||
                    this.reportPrompt._getStateProperty('promptNeeded') || !this.reportPrompt._getStateProperty('allowAutoSubmit');
              }
          ...
          _updateReportContentCore: function () {
            ...
            var styled = _isTopReportViewer && !isReportAlone &&
                isHtml && !isProportionalWidth && !inMobile;
              ...
              var scheduleScreenBtnCallbacks = [
                ...
                function scheduleReport() {
                  ...
                  if (me.reportPrompt._promptForLocation) {
                    //Open location dialog here - see the example of location update
                    /*var urlUpdateLocation = url.substring(0, url.indexOf("/api/repos")) + '/plugin/reporting/api/jobs/' + me._currentReportUuid + "/" + "5a8ba6eb-3d98-4a5c-9357-4a17848925a9"
                        + '/updateLocation';
                    pentahoGet(urlUpdateLocation, "");*/
                  }
